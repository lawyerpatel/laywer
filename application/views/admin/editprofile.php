            ...
            <div class="bg-lightest border-1px p-30 mb-0">
                                        ...
                                        <form id="finalprofile" name="form" action="<?php echo base_url() . 'home/finalProfile' ?>" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                ...
                                                <input id="form_attachment" name="filename" class="file" type="file" multiple data-show-upload="false" data-show-caption="true" tabindex="1">
                              <!--                  <small>Maximum upload file size: 12 MB</small>-->
                                            ...
                                            <div class="row">     
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <select name="year" id ="year_select" class="form-control" data-validation="required" tabindex="7">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <select name="month" id ="month_select" class="form-control" data-validation="required" tabindex="8">
                                                ...
                                                <div class="col-sm-3">
                                                    <input id="experienceText" type="text" disabled="disabled" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="bg-lightest border-1px p-10 mb-10" >
                                                ...
                                                <div class="row" >
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <input type="text" placeholder="Experience in year" id="experience" class="form-control" required="true" tabindex="12">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <a id="AddSpecialCancelButton" class="btn btn-danger is-small" onclick="">Cancel</a>
                                                        <a id="addExpertiseInButton" class="btn btn-success is-small is-success">Add</a>
                                                    </div>
                                                </div>
                                            </div>
