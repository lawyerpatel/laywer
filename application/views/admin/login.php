          ...
          <div class="container">
            <div class="row">
              <div class="col-md-6 col-md-push-3">
                ...
                <form name="login-form" class="clearfix" action="<?php echo base_url(); ?>admin/login" method="post">
                   <div class="row">
                    <div class="form-group col-md-12">
                      <label for="form_username_email">Username</label>
                      <input id="form_username_email" name="username" class="form-control" type="email" placeholder="User Email">
                    </div>
                  </div>
                  <div class="row">
                    <div class="form-group col-md-12">
