  ...
  <div class="main-content">
            ...
            <ul>
              ...
              <li data-index="rs-1" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="<?php echo base_url(); ?>fassets/images/bg/bg8.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description=""> 
                ...
                <div class="tp-caption tp-resizeme text-black font-raleway"
                  ...
                  style="z-index: 7; white-space: nowrap; font-weight:500;">We Have </div>
                ...
                <div class="tp-caption tp-resizeme text-theme-colored font-raleway" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 7; white-space: nowrap; font-weight:600; letter-spacing:1px;">Qualified Attorneys </div>
                ...
                <div class="tp-caption tp-resizeme text-black font-raleway" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap; letter-spacing:1px;">We Alawys Provide you awesome theme With high quality design! <br>
                  Your will be very happy to get this theme. </div>
                ...
                <div class="tp-caption" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a class="btn btn-dark btn-flat btn-theme-colored pl-20 pr-20 mt-sm-30" href="#">Read more</a> </div>
              </li>
              
              <!-- SLIDE 2 -->
              <li data-index="rs-2" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="<?php echo base_url(); ?>fassets/images/bg/bg9.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description=""> 
                <!-- MAIN IMAGE --> 
                <img src="<?php echo base_url(); ?>fassets/images/bg/bg9.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="5" data-no-retina> 
                <!-- LAYERS --> 
              ...
              <!-- SLIDE 3 -->
              <li data-index="rs-3" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="<?php echo base_url(); ?>fassets/images/bg/bg10.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description=""> 
                <!-- MAIN IMAGE --> 
                <img src="<?php echo base_url(); ?>fassets/images/bg/bg10.jpg"  alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="5" data-no-retina> 
                <!-- LAYERS --> 
    ...
    <section>
      <div class="container pt-0">
        <div class="row">
          <div class="col-md-7 wow fadeInUp" data-wow-duration="1.5s" data-wow-offset="10">
          ...
          <div class="col-md-5 wow fadeInUp" data-wow-duration="1.5s" data-wow-offset="10">
            <div class="thumb"> <img class="img-fullwidth" src="<?php echo base_url(); ?>fassets/images/blog-landing/blog-1-col-img4.jpg" alt=""> 
            </div>
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-3 mb-30">
              <div class="box-hover-effect effect2 bg-lightest-gray wow fadeInUp maxwidth400 p-10" data-wow-duration="1.5s" data-wow-offset="10">
                <div class="thumb"> <img class="img-responsive img-fullwidth" src="<?php echo base_url(); ?>fassets/images/practice/1.jpg" alt="featured project"  width="476">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 mb-30">
              <div class="box-hover-effect effect2 bg-lightest-gray wow fadeInUp maxwidth400 p-10" data-wow-duration="1.5s" data-wow-offset="10">
                <div class="thumb"> <img class="img-responsive img-fullwidth" src="<?php echo base_url(); ?>fassets/images/practice/2.jpg" alt="featured project"  width="476">
                  <div class="overlay white">
                    <div class="display-table">
                      <div class="display-table-cell">
                        <div class="overlay-details text-center">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 mb-30">
              <div class="box-hover-effect effect2 bg-lightest-gray wow fadeInUp maxwidth400 p-10" data-wow-duration="1.5s" data-wow-offset="10">
                <div class="thumb"> <img class="img-responsive img-fullwidth" src="<?php echo base_url(); ?>fassets/images/practice/3.jpg" alt="featured project"  width="476">
                  <div class="overlay white">
                    <div class="display-table">
                      <div class="display-table-cell">
                        <div class="overlay-details text-center">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 mb-30">
              <div class="box-hover-effect effect2 bg-lightest-gray wow fadeInUp maxwidth400 p-10" data-wow-duration="1.5s" data-wow-offset="10">
                <div class="thumb"> <img class="img-responsive img-fullwidth" src="<?php echo base_url(); ?>fassets/images/practice/4.jpg" alt="featured project"  width="476">
                  <div class="overlay white">
                    <div class="display-table">
                      <div class="display-table-cell">
                        <div class="overlay-details text-center">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 mb-30">
              <div class="box-hover-effect effect2 bg-lightest-gray wow fadeInUp maxwidth400 p-10" data-wow-duration="1.8s" data-wow-offset="10">
                <div class="thumb"> <img class="img-responsive img-fullwidth" src="<?php echo base_url(); ?>fassets/images/practice/5.jpg" alt="featured project"  width="476">
                  <div class="overlay white">
                    <div class="display-table">
                      <div class="display-table-cell">
                        <div class="overlay-details text-center">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 mb-30">
              <div class="box-hover-effect effect2 bg-lightest-gray wow fadeInUp maxwidth400 p-10" data-wow-duration="1.8s" data-wow-offset="10">
                <div class="thumb"> <img class="img-responsive img-fullwidth" src="<?php echo base_url(); ?>fassets/images/practice/6.jpg" alt="featured project"  width="476">
                  <div class="overlay white">
                    <div class="display-table">
                      <div class="display-table-cell">
                        <div class="overlay-details text-center">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 mb-30">
              <div class="box-hover-effect effect2 bg-lightest-gray wow fadeInUp maxwidth400 p-10" data-wow-duration="1.8s" data-wow-offset="10">
                <div class="thumb"> <img class="img-responsive img-fullwidth" src="<?php echo base_url(); ?>fassets/images/practice/7.jpg" alt="featured project"  width="476">
                  <div class="overlay white">
                    <div class="display-table">
                      <div class="display-table-cell">
                        <div class="overlay-details text-center">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 mb-30">
              <div class="box-hover-effect effect2 bg-lightest-gray wow fadeInUp maxwidth400 p-10" data-wow-duration="1.8s" data-wow-offset="10">
                <div class="thumb"> <img class="img-responsive img-fullwidth" src="<?php echo base_url(); ?>fassets/images/practice/8.jpg" alt="featured project"  width="476">
                  <div class="overlay white">
                    <div class="display-table">
                      <div class="display-table-cell">
                        <div class="overlay-details text-center">
    ...
    <section class="bg-no-repeat bg-img-cover">
      <div class="container pb-0">
        <div class="row">
          <div class="col-md-7 col-md-offset-1"> <img class="mt-10" src="<?php echo base_url(); ?>fassets/images/about/1.png" alt=""> </div>
            <div class="col-md-4 p-20">
              <div class="bg-deep p-30 pt-20">
                ...
                <!-- Appointment Form -->
                <form id="appointment_form" name="appointment_form" class="form-transparent form-line" method="post" action="http://thememascot.net/demo/html/mrlaw/v3/demo/includes/appointment.php">
                  <div class="row">
                    <div class="col-sm-12">
    ...
    <section class="divider parallax layer-overlay overlay-deep" data-stellar-background-ratio="0.5" data-bg-img="<?php echo base_url(); ?>fassets/images/bg/bg5.jpg">
      <div class="container pb-50">
        <div class="row">
          <div class="col-sm-5 mb-30">
            <div class="testimonial-carousel boxed wow fadeInUp" data-wow-duration="1.2s" data-wow-offset="10">
              <div class="item xs-text-center">
                <div class="content pt-10">
                  ...
                  <div class="thumb"><img width="75" class="img-circle" alt="" src="<?php echo base_url(); ?>fassets/images/testimonials/3.jpg"></div>
          ...
          <div class="col-sm-7">
            <div class="row equal-height wow fadeInUp" data-wow-duration="1.5s" data-wow-offset="10">
              <div class="col-xs-4 p-0">
                <div class="client-img"><a href="#"><img alt="" src="<?php echo base_url(); ?>fassets/images/clients/1.png"></a></div>
              </div>
              <div class="col-xs-4 p-0 bg-lightest">
                <div class="client-img"><a href="#"><img alt="" src="<?php echo base_url(); ?>fassets/images/clients/2.png"></a></div>
              </div>
              <div class="col-xs-4 p-0">
                <div class="client-img"><a href="#"><img alt="" src="<?php echo base_url(); ?>fassets/images/clients/3.png"></a></div>
              </div>
              <div class="col-xs-4 p-0 bg-lightest">
                <div class="client-img"><a href="#"><img alt="" src="<?php echo base_url(); ?>fassets/images/clients/4.png"></a></div>
              </div>
              <div class="col-xs-4 p-0">
                <div class="client-img"><a href="#"><img alt="" src="<?php echo base_url(); ?>fassets/images/clients/5.png"></a></div>
              </div>
              <div class="col-xs-4 p-0 bg-lightest">
                <div class="client-img"><a href="#"><img alt="" src="<?php echo base_url(); ?>fassets/images/clients/1.png"></a></div>
              </div>
        ...
        <div class="section-title title-border title-right icon-bg">
          <div class="row">
            <div class="col-md-12">
              ...
              <h2 class="mt-0 page-title"><i class="fa fa-edit"></i>News</h2>
              <p>Maecenas nec efficitur felis. Nulla egestas lacus sit
                amet lectus tincidunt condimentum.</p>
            </div>
          </div>
          ...
          <div class="row multi-row-clearfix">
            <div class="blog-posts">
              <div class="col-xs-12 col-sm-12 col-md-4">
                <article class="post clearfix box-hover-effect effect1 wow fadeInUp maxwidth600 mb-sm-30" data-wow-duration="1.2s" data-wow-offset="10">
                  <div class="entry-header">
                    <div class="post-thumb thumb"> 
                      <img class="img-responsive img-fullwidth" alt="" src="<?php echo base_url(); ?>fassets/images/blog/2.jpg"> 
                    </div>
                  </div>
              ...
              <div class="col-xs-12 col-sm-12 col-md-4">
                <article class="post clearfix box-hover-effect effect1 wow fadeInUp maxwidth600 mb-sm-30" data-wow-duration="1.5s" data-wow-offset="10">
                  <div class="entry-header">
                    <div class="post-thumb thumb"> 
                      <img class="img-responsive img-fullwidth" alt="" src="images/blog/2.jpg"> 
                    </div>
                  </div>
                  <div class="entry-content border-1px p-20">
                    <div class="entry-title pt-0">
              ...
              <div class="col-xs-12 col-sm-12 col-md-4">
                <article class="post clearfix box-hover-effect effect1 wow fadeInUp maxwidth600 mb-sm-30" data-wow-duration="1.8s" data-wow-offset="10">
                  <div class="entry-header">
                    <div class="post-thumb thumb"> 
                      <img class="img-responsive img-fullwidth" alt="" src="<?php echo base_url(); ?>fassets/images/blog/2.jpg"> 
                    </div>
